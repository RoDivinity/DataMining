...
wine$cluster[which(cluster$cluster == 1)] = 1
wine$cluster[which(cluster$cluster == 2)] = 2
wine$cluster[which(cluster$cluster == 3)] = 3
...
#cluster result
xtabs(~cluster$cluster + wine$color)
table = xtabs(~cluster$cluster + wine$color)
